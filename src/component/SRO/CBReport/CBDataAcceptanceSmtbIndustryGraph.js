...
//       },
//       axisBorder: {
//         show: true, // From CBVIDKYCSeedingIndustryGraph
//         color: "#e7e7e7", // From CBVIDKYCSeedingIndustryGraph
//       },
//       axisTicks: {
//         show: true, // From CBVIDKYCSeedingIndustryGraph
//         color: "#e7e7e7", // From CBVIDKYCSeedingIndustryGraph
...
//           return value.toFixed(2) + "%"; // Double decimal in tooltip
//         }
//       }
//     },
...
//   // UPDATED OPTIONS - ONLY CHANGED DATA LABELS COLOR TO BLACK
//   var options = {
//     chart: {
//       type: "line",
//       height: 450,
...
//         fontFamily: "sans-serif",
//         fontWeight: "bold",
//         colors: ["#000000"] // CHANGED: Numbers black color
//       },
//       background: {
//         enabled: false,
//       },
...
const CBDataAcceptanceIndustryGraph = ({ data }) => {
  ...
  var options = {
    ...
    dataLabels: {
      enabled: true,
      offsetY: -10, // CHANGED: Moved labels slightly upward
      formatter: function (val, opts) {
        var index = opts.dataPointIndex;
        if (opts.seriesIndex === 0) {
          return val === 0 ? "" : number_format(val);
