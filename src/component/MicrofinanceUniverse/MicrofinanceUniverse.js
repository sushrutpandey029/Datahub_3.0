...
import InventoryIcon from "@mui/icons-material/Inventory"; // Added for Product Mix
...
import ProductMixMaster from "../MicrofinanceUniverse/ProductMix/ProductMixMaster.js"
...
// Move this ABOVE MicrofinanceUniverse component
const ProductMix = () => {
  const classes = useStyle();

  // Static data for Product Mix
  const productMixData = [
    {
      product: "Income Generation Loans",
      accounts: "45,234",
      amount: "₹ 125.67 Cr",
      percentage: "42%",
    },
    {
      product: "Emergency Loans",
      accounts: "23,567",
      amount: "₹ 67.89 Cr",
      percentage: "23%",
    },
    ...
    {
      product: "Housing Loans",
      accounts: "12,345",
      amount: "₹ 38.90 Cr",
      percentage: "13%",
    },
    {
      product: "Agriculture Loans",
      accounts: "8,901",
      amount: "₹ 22.45 Cr",
      percentage: "7%",
    },
                ...
                <tbody>
                  {productMixData.map((product, index) => (
                    <tr
                      key={index}
                      className={
                        product.product === "Total" ? "table-warning" : ""
                      }
                    >
                      <td>
                        <strong>{product.product}</strong>
                      </td>
                      <td style={{ textAlign: "right" }}>{product.accounts}</td>
            ...
            <Box sx={{ width: "100%", typography: "body1" }}>
              <TabContext value={value}>
                <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                  ...
                  >
                    {userRole[1]["subkey"][0]["subkey_name"] == "Overview" &&
                    userRole[1]["subkey"][0]["subkey_checked"] == true ? (
                      <Tab
                        icon={<AnalyticsIcon />}
                        label="Overview"
                        value="1"
                    ...
                    {userRole[1]["subkey"][1]["subkey_name"] == "Outreach" &&
                    userRole[1]["subkey"][1]["subkey_checked"] == true ? (
                      <Tab
                        icon={<TableChartIcon />}
                        label="Outreach"
                        value="2"
                    ...
                    {userRole[1]["subkey"][2]["subkey_name"] ==
                      "Disbursement" &&
                    userRole[1]["subkey"][2]["subkey_checked"] == true ? (
                      <Tab
                        icon={<PaymentsIcon />}
                        label="Disbursement"
                        value="3"
                    ...
                    {userRole[1]["subkey"][3]["subkey_name"] ==
                      "Portfolio Quality" &&
                    userRole[1]["subkey"][3]["subkey_checked"] == true ? (
                      <Tab
                        ...
                        <CardActionArea>
                          <CardContent>
                            ...
                            >
                              <Link
                                className="App-link"
                                to="/micro-finance-universe/glp-trends-growth"
                              >
                        ...
                        <CardActionArea>
                          <CardContent>
                            ...
                            >
                              <Link
                                className="App-link"
                                to="/micro-finance-universe/uniuqe-borrowers-account-trends"
                              >
                                Click here to see details.
                              </Link>
                            </Typography>
                        ...
                        <CardActionArea>
                          <CardContent>
                            ...
                            >
                              <Link
                                className="App-link"
                                to="/micro-finance-universe/disbursement-trend"
                              >
                                Click here to see details.
                              </Link>
                            </Typography>
                      ...
                      <Card style={{ padding: "8px" }}>
                        <CardActionArea>
                          <CardContent>
                            <Typography>
                              <OverviewPARAnalysis
                                parAnalysisSeries={parAnalysisSeries}
                                xaxis={xaxis}
                              />
                            </Typography>
                            <Typography
                            ...
                            >
                              <Link
                                className="App-link"
                                to="/micro-finance-universe/par-analysis"
                              >
                                Click here to see details.
                              </Link>
                            </Typography>
                    ...
                    <Grid xs={12} sm={12} md={6}>
                      <Card style={{ padding: "8px" }}>
                        <CardActionArea>
                          <CardContent>
                            <Typography>
                              <OverviewPARBucketAnalysis
                                xaxis={xaxis}
                                parBucketAnalysisSeries={
                                  parBucketAnalysisSeries
                                }
                              />
                            </Typography>
                            ...
                            >
                              <Link
                                className="App-link"
                                to="/micro-finance-universe/par-bucket-analysis"
                              >
                                Click here to see details.
                              </Link>
                            </Typography>
                ...
                {/* ADDED PRODUCT MIX TAB PANEL - STATIC DUPLICATE */}
                <TabPanel value="5">
                  <ProductMixMaster />
                </TabPanel>
              </TabContext>
              ...
              {/* <Typography style={{ textAlign: "left", fontWeight: 500 }}>
                <strong>Data Source:</strong> Data up to 30 June 2023 sourced
                from Equifax, post 30 June 2023 data sourced from CRIF
              </Typography> */}
            </Box>
          </Grid>
        </Grid>
