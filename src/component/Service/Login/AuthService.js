...
import { BaseUrl,loginApi,loginOTOApi,DRIMapApi, ChangePasswordApi,ForgotPasswordApi, ChangePhoneApi,resetLoginStatusApi } from "../../url/url";
...
export const authResetLoginStatus = async (request) => {
  const api = `${resetLoginStatusApi}`;
  return await axios.post(`${BaseUrl}/${api}`, request);
};