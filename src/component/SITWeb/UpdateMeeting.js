  ...
  useEffect(() => {
    const fetchMeetingData = async () => {
      try {
        ...
        const showIncidentsOther =
          meetingData.incidents &&
          !incidentsOptions.includes(meetingData.incidents);
        ...
        const showSourceOther =
          meetingData.source_of_information &&
          !sourceOptions.includes(meetingData.source_of_information);
        ...
        setFormData((prev) => ({
          ...
          dynamicFields: {
            ...
            incidents: showIncidentsOther
              ? "Others"
              : meetingData.incidents || "",
            incidents_other: showIncidentsOther ? meetingData.incidents : "",
            sourceOfInformation: showSourceOther
              ? "Others"
              : meetingData.source_of_information || "",
            sourceOfInformation_other: showSourceOther
              ? meetingData.source_of_information
              : "",
              ...
              {isDisabled ? (
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: formData.dynamicFields[field.name] || "",
                  }}
                  style={{
                    padding: "8px",
        ...
        if (field.name === "region") {
          ...
          return (
            <select
              ...
              required={field.required}
              disabled={
                !formData.dynamicFields.region || isLoading.states || isDisabled
              }
            >
